...
class ScanTests(unittest.TestCase):
    ...
    def test_report_omits_raw_private_values(self) -> None:
        ...
        self.assertIn("- What it means:", report)
        self.assertIn("- Where to do it:", report)
        self.assertIn("- Settings or prompt?", report)
        self.assertIn("- How to apply it:", report)
        ...
        self.assertIn("Do you need to act now? No.", report)
        self.assertIn("Codex settings -> Custom instructions", report)
        self.assertIn("Use settings for habits you want everywhere; use a prompt only for one task", report)
